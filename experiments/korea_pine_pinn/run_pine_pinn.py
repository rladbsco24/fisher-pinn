...
def _preset_args(args: argparse.Namespace) -> list[str]:
    ...
    cmd = [
        ...
        "--pinn-intrinsic-phase-initial-weight",
        str(0.05 if args.preset == "flagship" else 0.03),
        "--pinn-intrinsic-phase-anchor-points",
        str(8192 if args.preset == "flagship" else 2048),
        "--pinn-intrinsic-phase-anchor-level",
        "0.10",
        "--pinn-intrinsic-phase-gradient-alignment-weight",
        str(0.02 if args.preset == "flagship" else 0.01),
        "--pinn-intrinsic-phase-monotonicity-weight",
        str(0.02 if args.preset == "flagship" else 0.01),
        "--pinn-intrinsic-phase-compatibility-points",
        str(4096 if args.preset == "flagship" else 512),

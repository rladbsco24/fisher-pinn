...
These tables follow the trapezoidal report-table style used in the project deck:
dark notebook-output rendering, compact monospace columns, and TimeRef-based
time-error analysis.

![1D RK4 spatial comparison table](rk4_table_1d_spatial_comparison.png)

![1D RK4 time-error analysis table](rk4_table_1d_time_comparison.png)

![2D RK4 spatial comparison table](rk4_table_2d_spatial_comparison.png)

![2D RK4 time-error analysis table](rk4_table_2d_time_comparison.png)
